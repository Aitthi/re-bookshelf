  ...
  describe('Collection', function () {
    ...
    describe('#fetch()', function () {
      it('fetches the models in a collection', function () {
        return bookshelf.Collection.extend({tableName: 'posts'}).forge().fetch().tap(checkTest(this));
      });
    ...
    describe('#clone()', function () {
      it('should contain a copy of internal QueryBuilder object - #945', function () {
        var original = Post.collection().query('where', 'share_count', '>', 10).query('orderBy', 'created_at');
